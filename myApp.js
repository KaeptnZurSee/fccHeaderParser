...
var createAndSavePerson = function(done){
  var person = new Person({name:"Joe", age:"25", favoriteFoods:["garbage","dirt"]}) 
...
var queryChain = function(done) {
  ...
  Person.find({favoriteFoods:foodToSearch}).sort('name').limit(2).select("-age").exec((err,data)=> done(null,data));
};
